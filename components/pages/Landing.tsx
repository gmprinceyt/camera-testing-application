...
export function Landing() {
  ...
  const usage = 327;
  return (
    <div className="w-full h-full  overflow-hidden lg:h-screen lg:px-16 px-4.5 sm:px-8 bg-linear-to-b from-yellow-600 to-yellow-300 dark:from-[#312b0b] dark:to-[#000000]">
      <Navbar />
      <div className="flex relative lg:flex-row flex-col gap-20  lg:gap-5 mt-14 h-[calc(100vh-116px)]   lg:h-[calc(100vh-136px)] z-9">
        ...
        <div className="space-y-6">
          <h1 className="font-extrabold text-shadow-md text-[55px] leading-15 lg:text-[72px] lg:leading-20 max-w-159.75">
            Test Your <span className="text-[#ffd500]">Camera</span> in One Click
          </h1>
        ...
        <div className="relative">
          <Image
            ...
            className="animate-bounce animation-duration-[10s]"
            src={"/hero.png"}
            height={500}
            width={500}
          />
          <div className=" text-shadow-md absolute top-0 right-7 flex flex-col items-center rotate-12 -space-y-1 font-mono">
            <span className="text-[20px] ">{usage}+</span>
            <strong>Total Pepole are tested</strong>
          </div>
        </div>
      </div>
      ...
      <Image
        alt="Background-image"
        className="absolute left-0 top-16 animate-bounce animation-duration-[10s]"
        src={"/Circlebg.svg"}
        height={218}
        width={218}
        loading="eager"
